...
const COMPUTERS_MODEL = './models/computers_1-transformed.glb'
...
export function Instances({ children, ...props }) {
  const { nodes } = useGLTF(COMPUTERS_MODEL)
...
export function Computers({ lite = false, ...props }) {
  const { nodes: n, materials: m } = useGLTF(COMPUTERS_MODEL)
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenInteractive lite={lite} frame="Object_206" panel="Object_207" position={[0.27, 1.53, -2.61]} />
      <ScreenText lite={lite} frame="Object_209" panel="Object_210" y={5} position={[-1.43, 2.5, -1.8]} rotation={[0, 1, 0]} />
      <ScreenText lite={lite} invert frame="Object_212" panel="Object_213" x={-5} y={5} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
      <ScreenText lite={lite} invert frame="Object_215" panel="Object_216" position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} />
      <ScreenText lite={lite} invert frame="Object_218" panel="Object_219" x={-5} position={[3.11, 2.15, -0.18]} rotation={[0, -0.79, 0]} scale={0.81} />
      <ScreenText lite={lite} frame="Object_221" panel="Object_222" y={5} position={[-3.42, 3.06, 1.3]} rotation={[0, 1.22, 0]} scale={0.9} />
      <ScreenText lite={lite} invert frame="Object_224" panel="Object_225" position={[-3.9, 4.29, -2.64]} rotation={[0, 0.54, 0]} />
      <ScreenText lite={lite} frame="Object_227" panel="Object_228" position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
      <ScreenText lite={lite} frame="Object_230" panel="Object_231" position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
...
function Screen({ frame, panel, children, lite = false, ...props }) {
  const { nodes, materials } = useGLTF(COMPUTERS_MODEL)
  return (
    <group {...props}>
      <mesh castShadow receiveShadow geometry={nodes[frame].geometry} material={materials.Texture} />
      <mesh geometry={nodes[panel].geometry}>
        {lite ? (
          <meshBasicMaterial color="#35c19f" toneMapped={false} />
        ) : (
          <meshBasicMaterial toneMapped={false}>
            <RenderTexture width={256} height={256} attach="map" anisotropy={4}>
              {children}
            </RenderTexture>
          </meshBasicMaterial>
        )}
...
function ScreenInteractive({ lite = false, ...props }) {
  return (
    <Screen lite={lite} {...props}>
      {!lite && (
        <>
...
useGLTF.preload(COMPUTERS_MODEL)
